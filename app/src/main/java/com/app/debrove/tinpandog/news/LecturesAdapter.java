...
public class LecturesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    @NonNull
    private List<Lectures> mList;
    private OnRecyclerViewItemOnClickListener mListener;

    public LecturesAdapter(@NonNull List<Lectures> list, @NonNull Context context) {
        this.mList = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ItemViewHolder) {
            Lectures item = getItem(position);
     ...
     */
    private Lectures getItem(int position) {
    ...
    public void updateData(@NonNull List<Lectures> list) {
        mList.clear();
        mList.addAll(list);
